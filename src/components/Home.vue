    ...
    >
      <div class="px-2 pt-2">
        <div class="text-primary-content rounded-box space-x-1">
          <div class="mx-2 flex-1 justify-center px-2 transition-all duration-200 md:flex md:justify-start">
      ...
      <div
        id="component-demo"
        class="flex w-full grid grid-cols-1 items-center gap-4 overflow-x-auto px-10 pt-1 pb-10 transition-all duration-200 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4"
      >
